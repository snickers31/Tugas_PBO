 ...
 * @author MSiUser
 */
public class DeleteBarang extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
